...
class AboutMe extends Component {
  renderAboutMeBody() {
    const aboutMe = `Hi, I'm Kyle! I'm a full stack software engineer with experience in Ruby
    on Rails, ReactJS, and Elixir! I was born and raised in NYC but now I'm in Boston in my
    last year at Northeastern University working on my Bachelor's degree in
    ...
    return (
      <div className="aboutme__body is-size-5 item">
